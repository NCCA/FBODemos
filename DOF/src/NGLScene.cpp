...
void NGLScene::initializeGL()
{
  ...
  ngl::NGLMessage::addMessage(fmt::format("RenderTargetID {0}", m_renderFBO->getTextureID("renderTarget")));
  m_renderFBO->print();
  ngl::NGLMessage::addMessage(fmt::format("Is complete {0}", m_renderFBO->isComplete()));
  ...
  ngl::NGLMessage::addMessage(fmt::format("blurTarget {0}", m_blurFBO->getTextureID("blurTarget")));
  m_renderFBO->print();
  ngl::NGLMessage::addMessage(fmt::format("Is complete {0}", m_blurFBO->isComplete()));
